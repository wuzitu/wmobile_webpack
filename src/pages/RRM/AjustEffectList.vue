<template>
    <van-collapse v-model="activeNames">
        <van-collapse-item v-for="(a1, indexa1) in oData.ajustEffectListData" :name="oData.activeName + indexa1">
            <template #title>
...
const { t } = useI18n()
let oData = defineProps({ ajustEffectListData: Array, activeName: String })
</script>
<style scoped>
.contents {
    padding-left: 20px;
